 ...
 */
public class MainTest_HUOP_P1P3 {
...
//		String utility_table_input = "src/TestDatasets/2DB_UtilityTable.txt";  
		...
		String input = "src/TestDatasets/BMSPOS2_UM_New.txt";  
		String utility_table_input = "src/TestDatasets/BMSPOS2_UM_UtilityTable.txt";  
		String output = ".//output_HUOI.txt";

		//==============================
		double minSupport = 0.0002;  // the minimum support threshold, (0,1]
		double minUtilOccu = 0.24;  // the minimum utility occupancy threshold, (0,1]	
		int k=1;
		//==============================
		
		long SumTime = 0;
		System.out.println("    ============  HUOP (P1 + P3) Algorithm !!! ============ " );
		...
		for(int i=0; i<k; i++){
			...
			AlgoHUOP_P1P3 HUOP = new AlgoHUOP_P1P3();
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTest_HUOP_P1P3.class.getResource(filename);
